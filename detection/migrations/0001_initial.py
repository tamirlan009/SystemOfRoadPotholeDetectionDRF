    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count_pothole', models.IntegerField(blank=True, null=True, verbose_name='count find objects')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count_img_pothole', models.IntegerField(blank=True, null=True, verbose_name='count find objects in image')),
                ('date_table_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='detection.detectedtable')),
            ],
            options={
